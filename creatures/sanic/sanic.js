...
fishcotheque.createCreature('sanic', function (creature) {
  ...
  creature.size({width: 144, height: 108});
  ...
  element.on('click', function (e) {
    ...
    element.css({
      ...
      creature.chat('Gotta go fast!')
  });
  
  fishcotheque.loadCSS('creatures/sanic/sanic.css');
